...
const Layout: React.FC = () => {
  ...
  return (
    <MainRightInsetContext.Provider value={setMainRightInset}>
      <div className="pinm-app-shell editorial-shell flex flex-col h-screen">
        <ScrollingBanner />
            ...
            <div className="lg:hidden fixed inset-0 z-50 flex">
              ...
              <div className="relative h-full shadow-xl">
                ...
                <button
                  type="button"
                  onClick={() => setMobileNavOpen(false)}
                  className="absolute top-3 right-3 p-2 rounded-md bg-[var(--editorial-bg)] text-[var(--editorial-muted)] border border-[var(--editorial-border)]"
                  aria-label="Yopish"
                >
                  <X className="w-5 h-5" />
                </button>
